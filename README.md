...
松峰老师还提到，翻译的过程也存在流失的现象。既然书的内容以文字作为载体，那呈现内容本身的，不仅有文字，还有文字之间的结构，也即是文字的形式。形式不是内容的表现形式，形式就是内容本身。虽然在技术作品中这一点不如文学类作品体现得明显。这里的文字的形式，包含但不限于标点的使用、句子断在哪里、前后单词押韵带来的节奏和结构、句子的排比、意象的安排、段落间的结构等。在英文转中文的过程中，不可避免受到损失的主要有英文相关的形式丢失或减弱了，比如句子的断句、标点的使用、个别单词的押韵、不合本土习惯的比喻、双关等。
